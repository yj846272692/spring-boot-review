...
public class SqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        String packageName = "D:\\dev\\SpringBoot\\spring-boot-review\\spring-boot-jpa\\src\\main\\java\\com\\soft1851\\springboot\\jpa\\model";
        //生成sql的文件夹
        String filePath = "D:\\resources";
        //项目中实体类的路径
        String prefix = "com.soft1851.springboot.jpa.model.";
        String className = "";
        ...
        StringToSql(sqls.toString(), filePath + "user.sql");
